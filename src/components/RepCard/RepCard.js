    ...
    <div className="rep-card">
      ...
      <div className="bio-info">
        ...
        <div className="bio-text-container">
          ...
          <p className="bio-text bio-party">Party: {repData.attributes.biography.party}</p>
          ...
          <p className="bio-text bio-age">Age: {repData.attributes.biography.age}</p>
          <p className="bio-text bio-gender">Gender: {repData.attributes.biography.gender}</p>
          <p className="bio-text bio-term">Years in office: {repData.attributes.biography.years_in_office}</p>
