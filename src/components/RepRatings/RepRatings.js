  ...
  return (
    <section className="rep-issues-container">
      ...
      {repData.attributes.rating.planned_parenthood !== null ? 
        ...
        :
        <p>Planned Parenthood has not given this {repData.attributes.biography.congressional_type} a rating yet.</p>
      }
      ...
      {repData.attributes.rating.americans_for_prosperity !== null ?
        ...
        :
        <p>Americans for Prosperity has not given this {repData.attributes.biography.congressional_type} a rating yet.</p>
      }
      ...
      {repData.attributes.rating.aclu !== null ? 
        ...
        :
        <p>The ACLU has not given this {repData.attributes.biography.congressional_type} a rating yet.</p>
      }
      ...
      {repData.attributes.rating.end_citizens_united !== null ? 
        ...
        : 
        <p>End Citizens United has not given this {repData.attributes.biography.congressional_type} a rating yet.</p>
      }
      ...
      {repData.attributes.rating.national_association_of_police !== null ? 
        ...
        :
        <p>National Assoc. of Police Org has not given this{repData.attributes.biography.congressional_type} a rating yet.</p>
      }
      ...
      {repData.attributes.rating.national_parks_conservation !== null ?
        ...
        :
        <p>National Parks Conservation Assoc. has not given this {repData.attributes.biography.congressional_type} a rating yet.</p>
      }
      ...
      {repData.attributes.rating.nra !== null ? 
        ...
        :
        <p>The NRA has not given this {repData.attributes.biography.congressional_type} a rating yet.</p>
      }
      ...
      {repData.attributes.rating.numbers_usa !== null ?
        ...
        :
        <p>NumbersUSA has not given this {repData.attributes.biography.congressional_type} a rating yet.</p>
      }
      ...
      {repData.attributes.rating.norml !== null ?
        ...
        :
        <p>Norml has not given this {repData.attributes.biography.congressional_type} a rating yet.</p>
      }
    </section>
  );
};
